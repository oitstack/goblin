 ...
 */
public class PullStrategyContext {

    /**
     * Pull images according to policy.
     * @param pullStrategy specified image pull policy
     * @param imageName image info
     * @return
     */
    public boolean pull(PullStrategy pullStrategy, DockerImageName imageName, DockerClient dockerClient) {
        return pullStrategy.pull(imageName,dockerClient);
    }
}

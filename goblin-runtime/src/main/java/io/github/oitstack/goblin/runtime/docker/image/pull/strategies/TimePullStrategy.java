...
/**
 *  Image pull strategy, first judge whether it has expired, then refresh the cache.
 * @Author CuttleFish
 * @Date 2022/2/28 下午2:23
 */
public class TimePullStrategy implements PullStrategy {

    /**
     * Image fetch strategy.
     */
    private ImageFetcher fetcher = new AgeJudgeImageFetcherDecorator(
            new RefreshCacheImageFetcherDecorator(
                    new DirectImageFetcher()));
